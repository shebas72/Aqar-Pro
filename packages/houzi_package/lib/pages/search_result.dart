...
class SearchResultState extends State<SearchResult> {
  ...
  if (mapFromFilterScreen[BEDROOMS] is List) {
    tempBedroomStringList = List<String>.from(mapFromFilterScreen[BEDROOMS].map((e) => e.toString()));
  } else {
  ...
  if (mapFromFilterScreen[BATHROOMS] is List) {
    tempBathroomStringList = List<String>.from(mapFromFilterScreen[BATHROOMS].map((e) => e.toString()));
  } else {
    tempBathroomStringList = [mapFromFilterScreen[BATHROOMS].toString()];
  }
