...
class InAppPurchaseViewModel {
    ...
    if (purchase.pendingCompletePurchase) {
      ...
      try {
        ...
        Map<String, dynamic> params = {
          ...
          InAppPurchaseResponseKey : iapJson,
          InAppPurchasePackageIdKey : packageId,
          InAppPurchasePropertyIdKey : propId,
          InAppPurchasePropertyFeaturedKey : isFeaturedForPerListing ? 1 : 0,
        };

        print("dataMap: $params");
  ...
  void purchaseProduct(BuildContext context, ProductDetails product,
    ...
    try {
      ...
      final username = HiveStorageManager.getUserName() ?? "";
      final PurchaseParam purchaseParam =
          PurchaseParam(productDetails: product, applicationUserName: username);
      initialState = PaymentDataState(products, true, true);
      _paymentStateController.add(initialState!);
