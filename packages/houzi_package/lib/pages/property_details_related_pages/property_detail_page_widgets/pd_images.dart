...
class _PropertyDetailPageImagesState extends State<PropertyDetailPageImages> {
  ...
  ///
  /// Depricated: This method is not used in the current code. It was previously used to load data into the imageUrlsList.
  /// 
  /// 
  ...
  //     if(imageUrlsList[0].isEmpty){
  //       imageUrlsList.removeAt(0);
  //       // imageUrlsList.insert(0, firstImage);
  //     }else{
  //       imageUrlsList.insert(0, firstImage);
  //     }
  //   print("Image list being load: $imageUrlsList");
  //   }
  //   if (imageUrlsList.isEmpty && widget.thumbnail.isNotEmpty) {
  //     imageUrlsList.add(widget.thumbnail);
  //     print("Image list being load with thumbnail: $imageUrlsList");
  //   }

  //   setState(() {});
  // }

  /// [New] This method is used to load data into the imageUrlsList.
  loadData(Article article) {
  imageUrlsList = article.imageList ?? [];
  ...
  if (firstImage.isNotEmpty && (imageUrlsList.isEmpty || imageUrlsList.first != firstImage)) {
    imageUrlsList.insert(0, firstImage);
  }
