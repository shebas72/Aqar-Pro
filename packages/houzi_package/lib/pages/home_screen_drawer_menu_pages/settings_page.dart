...
import 'package:houzi_package/pages/app_settings_pages/currency_switcher_settings.dart';
...
class HomePageSettingsState extends State<HomePageSettings> {
  ...
  void initState() {
    super.initState();
    // print("Here is the status: $cwStatus");
    ...
    return GenericSettingsWidget(
      ...
      body: Column(
        ...
        children: [
          ...
          GenericWidgetRow(
            padding: const EdgeInsets.only(top: 10.0, bottom: 10.0),
            iconData: AppThemePreferences.currencyIcon,
            text: UtilityMethods.getLocalizedString("switch_currency"),
            removeDecoration: true,
            onTap: ()=> onCurrencySettingsTap(context),
          ),
  ...
  void onCurrencySettingsTap(BuildContext context){
    UtilityMethods.navigateToRoute(
        context: context,
        builder: (context) => CurrencySwitcherSettings(),
    );
  }
