...
class _AddPropertyV2State extends State<AddPropertyV2> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    addPropertyDataMap[ADD_PROPERTY_SIZE_PREFIX] = MEASUREMENT_UNIT_TEXT;
    addPropertyDataMap[ADD_PROPERTY_LAND_AREA_PREFIX] = MEASUREMENT_UNIT_TEXT;
  ...
  fetchUserPaymentStatus() async {
    if (!widget.isPropertyForUpdate) {
      ...
      if (response.success && response.internet && response.result != null) {
        ...
        print("[Add Property V2] User Payment Status: ${_apiManager.convertUserPaymentStatusToJson(userPaymentStatus)}");
  ...
  Widget build(BuildContext context) {
    //print("Add Property V2: $addPropertyDataMap");
    return WillPopScope(
      onWillPop: onWillPop,
      child: Scaffold(
        appBar: AppBarWidget(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              elevation: 0.0,
                              foregroundColor: AppThemePreferences().appTheme.selectedItemTextColor,
                        ...
                        Expanded(child : pageIndicators()),
                        /// Done / Next Button:
                        Flexible(
                          child: ElevatedButton(
                            child: Text( _page == _addPropertyPages.length
                                ? UtilityMethods.getLocalizedString("done")
                                : UtilityMethods.getLocalizedString("next"), maxLines: 1,
                            style:
                                const TextStyle(
                                  color: Colors.white,
                                )
                            ...
                            onPressed: () {
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                elevation: 0.0, backgroundColor: AppThemePreferences.actionButtonBackgroundColor,
                                shape: const RoundedRectangleBorder(
                                  borderRadius: BorderRadius.all(Radius.circular(5)),
                                ),
                                // primary: color != null ? color : AppThemePreferences().current.primaryColor,
            ...
            if (isFormPageAllowedForCurrentUser(page)) {
              ...
              _addPropertyPages.add(
                 ...
                 AddPropertyFormWidget(
                   ...
                   formSectionFieldsList: page.pageFields != null ? page.pageFields ?? [] : [],
