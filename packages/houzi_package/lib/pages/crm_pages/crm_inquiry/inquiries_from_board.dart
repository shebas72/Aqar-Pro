...
import 'package:houzi_package/pages/crm_pages/crm_inquiry/add_new_inquiry_page.dart';
...
class _InquiriesFromBoardState extends State<InquiriesFromBoard> {
  ...
  Future<List<dynamic>> fetchInquiriesFromBoard(int page) async {
    ...
    ApiResponse<List> response = await _apiManagerCRM.fetchInquiriesFromBoard(page, perPage);
