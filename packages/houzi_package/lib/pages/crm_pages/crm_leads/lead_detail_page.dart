...
class _LeadDetailPageState extends State<LeadDetailPage> {
  ...
  Future<List<dynamic>> fetchLeadDetail() async {
    List tempList = [];
    ApiResponse<List> response = await _apiManagerCRM.fetchLeadsInquiriesFromBoard(widget.idForFetchLead!, 1, fetchLeadDetail: true);
              ...
              actions: <Widget>[
                ...
                TextButtonWidget(
                  onPressed: () async {
                    ...
                    if (leadID != null) {
                      ApiResponse<String> response = await _apiManagerCRM.deleteLead(leadID, nonce);
                      if (response.success) {
