...
class _AllReviewsState extends State<AllReviews> {
  ...
  Future<List<dynamic>> fetchPropertyReviews(int propertyId, int page, int perPage) async {
    ...
    ApiResponse<List> response = await _apiManager.listingReviews(propertyId, page.toString(), perPage.toString());
  ...
  Future<List<dynamic>> fetchReviews(int propertyId, int page, int perPage, String type) async {
    ...
    ApiResponse<List> response = await _apiManager.realtorReviews(propertyId, page.toString(), perPage.toString(), type);
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => RealtorInformationDisplayPage(
                  ...
                  agentType: widget.reviewPostType == USER_ROLE_AGENT_VALUE ? AGENT_INFO : AGENCY_INFO,
                ),
              ),
            );
          }
