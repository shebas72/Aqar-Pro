...
import 'package:houzi_package/widgets/form_widgets/form_price_text_field_widget.dart';
            ...
            child: widget.formSectionFieldsList.isNotEmpty
                ? SectionFieldsWidget(
                    ...
                    listener: (dataMap) {
                      ...
                      if (mounted && dataMap.containsKey(ADD_PROPERTY_MAP_ADDRESS)) {
                        setState(() {});
                      }
                    },
                  )
    ...
    return Column(
      children: widget.formItemsList.map((houziFormItem) {
        if (showFormItem(houziFormItem)) {
          ...
          switch (type) {
            case formTextField: {
              if(houziFormItem.apiKey == ADD_PROPERTY_PRICE) {
                return GenericPriceFormTextFieldWidget(
