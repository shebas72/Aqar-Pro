...
class HooksV2 implements HooksV2Interface {
  ...
  PropertyPageWidgetsHook getWidgetHook() {
    PropertyPageWidgetsHook
    detailsHook = (BuildContext context, Article article, String hook) {
  ...
  LanguageHook getLanguageCodeAndName() {
    LanguageHook languageHook = () {
      ...
      Map<String, dynamic> yourLanguageMap = {
        ...
        "languageCodeForURL":
            "YOUR-LANGUAGE-CODE-FOR-URL", // Optional (Specify your language code for URL)
      };
  ...
  HomeRightBarButtonWidgetHook getHomeRightBarButtonWidgetHook() {
    HomeRightBarButtonWidgetHook
    homeRightBarButtonWidgetHook = (BuildContext context) {
      ///
      ///
    ...
    DrawerHook drawerHook = (BuildContext context) {
      DrawerItem drawerItem = DrawerItem(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AllAgents()),
          );
        },
        insertAt: 3,
      );
        ...
        expansionTileChildren: [
          DrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ActivitiesFromBoard()),
              );
            },
          ),
          DrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => InquiriesFromBoard()),
              );
            },
          ),
          DrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => DealsFromBoard()),
              );
            },
          ),
          DrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LeadsFromBoard()),
              );
            },
          ),
        ],
  ...
  MembershipPlanHook getMembershipPlanHook() {
    MembershipPlanHook
    membershipPlanHook = (BuildContext context, List<dynamic> membershipPackageList) {
  ...
  DrawerWidgetsHook getDrawerWidgetsHook() {
    DrawerWidgetsHook
    drawerWidgetsHook = (BuildContext context, String? hookName) {
      /// Copy and Paste the sample code provide below.
      ///
      /// Replace the 'HOOK_NAME' with that specific hookName that you define in
      /// json via Houzi Builder Desktop application and replace your
  ...
  HomeWidgetsHook getHomeWidgetsHook() {
    HomeWidgetsHook
    homeWidgetsHook = (BuildContext context, String? hookName, bool isRefreshed) {
      /// Copy and Paste the sample code provide below.
      ///
      /// Replace the 'HOOK_NAME' with that specific hookName that you define in
      /// json via Houzi Builder Desktop application and replace your
  ...
  NavbarWidgetsHook getNavbarWidgetsHook() {
    NavbarWidgetsHook
    navbarWidgetsHook = (BuildContext context, String? hookName) {
      /// Copy and Paste the sample code provide below.
      ///
      /// Replace the 'HOOK_NAME' with that specific hookName that you define in
      /// json via Houzi Builder Desktop application and replace your
